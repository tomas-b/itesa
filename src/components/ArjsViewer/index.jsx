...
const ARjs = () => {
            ...
            tag.addEventListener("markerFound", (event) => {
                db.collection("users")
                    ...
                    .then(async (data) => {
                        ...
                        let div = document.getElementById("Encontrar");
                        if (arr.includes(event.target.id)) {
                            puntos = data.points;
                            div.textContent = "¡Ya escaneaste este producto!";
                        } else {
                            div.textContent = `El producto que escaneaste es un/a ${event.target.id}`;
    ...
    return (
        <div>
            ...
            >
                ¡Escanea Algun Producto Para Sumar Puntos!
            </div>
            <div>
                <a-scene
